        ...
        <div className="grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-4 px-6 py-4">
          ...
          <div className="hidden md:block">
            <button
              ...
              className="mx-auto flex h-10 w-full max-w-md items-center gap-2 rounded-full border border-border bg-card px-4 text-left text-sm text-muted-foreground transition-colors hover:border-primary/40 hover:bg-accent/40"
            >
              <Search className="h-4 w-4" />
              <span>Search features, inventory, invoices, reviews…</span>
